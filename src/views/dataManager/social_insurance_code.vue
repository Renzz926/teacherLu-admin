<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="social_insurance_codeList" @selection-change="handleSelectionChange">
...
<script>
import { listSocial_insurance_code, getSocial_insurance_code, delSocial_insurance_code, addSocial_insurance_code, updateSocial_insurance_code, exportSocial_insurance_code } from "@/api/social_insurance_code";
