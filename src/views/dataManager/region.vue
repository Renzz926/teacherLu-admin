    ...
    <el-dialog :visible="addConfigVisible">
      ...
      >
        ...
        <el-form-item label="标准乡镇街道名" prop="standardStreet">
          <el-input
            v-model="configForm.standardStreet"
            style="width: 300px"
          ></el-input>
        </el-form-item>
        ...
        <el-form-item label="户籍村社id" prop="hjCommunityId">
          <el-input
            v-model="configForm.hjCommunityId"
            style="width: 300px"
          ></el-input>
        </el-form-item>
        <el-form-item label="省全员村社id" prop="sqyCommunityId">
          <el-input
            v-model="configForm.sqyCommunityId"
            style="width: 300px"
          ></el-input>
        </el-form-item>
