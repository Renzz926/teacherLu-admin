  ...
  <div class="main">
    <div style="margin: 15px">
      ...
      <el-button
        ...
        plain
      >
        <a href="/demoRenFan.xlsx" download="人房关系表模板.xlsx"
          >人房关系表模板下载</a
        >
      </el-button>
    </div>
...
import { download, upload, changeAnalysisRenFan } from "@/api/tags/file";
// import $qs from qs;
export default {
  data() {
    return {
  ...
  methods: {
    ...
    updateAnalysis(row) {
      ...
      timer;
      changeAnalysisRenFan(fd, getToken())
        .then((res) => {
          this.getList();
        })
        .catch((err) => {
